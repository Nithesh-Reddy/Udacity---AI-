...
def classify_images(images_dir, results_dic, model):
    ...
    for key in results_dic:
       ...
       model_label_list_strip = [elem.strip() for elem in model_label_list]
       # defines truth as pet image label 
       truth = results_dic[key][0]
       #print(truth)
       #print(model_label)
       #print(model_label_list_strip)
       ...
       if truth in model_label_list_strip:
           results_dic[key].extend(model_label_list_strip)
